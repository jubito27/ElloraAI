...
@st.cache_resource
def initialize_qa_chain(persist_directory="chromadbstore"):
...
if __name__ == "__main__":
    # Example usage
    while True:
        query = input("Enter your question about Vedic texts (or type 'exit' to quit): ")
        if query.lower() == 'exit':
            break
        get_vedic_response(query)
